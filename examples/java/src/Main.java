...
//        System.out.println("hash : " + hash);
    ...
    public static void test() throws CipherException, InvalidAlgorithmParameterException, NoSuchAlgorithmException, NoSuchProviderException, IOException {
        NewTools tools = new NewTools(rpcUrl);
        System.out.println(tools.getPublicKeyByPrivateKey("0x24b7a614c5e0e200cbabe1a623183c165964466dbe12eb643d7d970aeef7c337"));
        WalletUtils.generateNewWalletFile("12", new File("/Users/erhu/project/gitrepo/newchain-sdk-example/examples/java/src/"));
    }
}
