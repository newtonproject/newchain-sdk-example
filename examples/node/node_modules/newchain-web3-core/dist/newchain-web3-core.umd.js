(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@babel/runtime/helpers/classCallCheck'), require('@babel/runtime/helpers/createClass'), require('lodash/isObject'), require('web3-providers'), require('newchain-web3-core-method'), require('newchain-web3-utils')) :
    typeof define === 'function' && define.amd ? define(['exports', '@babel/runtime/helpers/classCallCheck', '@babel/runtime/helpers/createClass', 'lodash/isObject', 'web3-providers', 'newchain-web3-core-method', 'newchain-web3-utils'], factory) :
    (global = global || self, factory(global.Web3Core = {}, global._classCallCheck, global._createClass, global.isObject, global.web3Providers, global.newchainWeb3CoreMethod, global.newchainWeb3Utils));
}(this, function (exports, _classCallCheck, _createClass, isObject, web3Providers, newchainWeb3CoreMethod, newchainWeb3Utils) { 'use strict';
    ...
    function () {
      function AbstractWeb3Module(provider) {
        ...
        this._defaultAccount = options.defaultAccount ? newchainWeb3Utils.toChecksumAddress(options.defaultAccount) : undefined;
        ...
        if (methodFactory) {
          return new newchainWeb3CoreMethod.MethodProxy(this, methodFactory);
        }
      }
      _createClass(AbstractWeb3Module, [{
        ...
        ,
        set: function set(value) {
          this._defaultAccount = newchainWeb3Utils.toChecksumAddress(value);
        }
      }, {
        key: "currentProvider",
        get: function get() {
