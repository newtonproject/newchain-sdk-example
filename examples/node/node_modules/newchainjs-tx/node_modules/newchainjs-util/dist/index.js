...
exports.ecsign = function (msgHash, privateKey, chainId) {
  ...
  var sig = ec.sign(msgHash, privateKey);
  var ret = {};
...
exports.ecrecover = function (msgHash, v, r, s, chainId) {
  var signature = { r: exports.setLength(r, 32), s: exports.setLength(s, 32) };
  var recovery = calculateSigRecovery(v, chainId);
  if (!isValidSigRecovery(recovery)) {
    throw new Error('Invalid signature v value');
  }
  var publicKeyObject = ec.recoverPubKey(msgHash, signature, recovery);
  var x = publicKeyObject.getX();
  var y = publicKeyObject.getY();
