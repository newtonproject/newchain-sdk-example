(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('newchain-web3-utils'), require('web3-core-helpers'), require('@babel/runtime/helpers/classCallCheck'), require('@babel/runtime/helpers/possibleConstructorReturn'), require('@babel/runtime/helpers/getPrototypeOf'), require('@babel/runtime/helpers/inherits'), require('newchain-web3-core-method'), require('@babel/runtime/regenerator'), require('@babel/runtime/helpers/asyncToGenerator'), require('@babel/runtime/helpers/createClass'), require('@babel/runtime/helpers/assertThisInitialized'), require('lodash/isFunction'), require('lodash/isObject'), require('lodash/isBoolean'), require('newchain-lib/lib/hash'), require('newchain-lib/lib/rlp'), require('newchain-lib/lib/bytes'), require('newchain-lib/lib/account'), require('newchain-web3-core'), require('scrypt.js'), require('lodash/isString'), require('uuid')) :
    typeof define === 'function' && define.amd ? define(['exports', 'newchain-web3-utils', 'web3-core-helpers', '@babel/runtime/helpers/classCallCheck', '@babel/runtime/helpers/possibleConstructorReturn', '@babel/runtime/helpers/getPrototypeOf', '@babel/runtime/helpers/inherits', 'newchain-web3-core-method', '@babel/runtime/regenerator', '@babel/runtime/helpers/asyncToGenerator', '@babel/runtime/helpers/createClass', '@babel/runtime/helpers/assertThisInitialized', 'lodash/isFunction', 'lodash/isObject', 'lodash/isBoolean', 'newchain-lib/lib/hash', 'newchain-lib/lib/rlp', 'newchain-lib/lib/bytes', 'newchain-lib/lib/account', 'newchain-web3-core', 'scrypt.js', 'lodash/isString', 'uuid'], factory) :
    (global = global || self, factory(global.Web3EthAccounts = {}, global.Utils, global.web3CoreHelpers, global._classCallCheck, global._possibleConstructorReturn, global._getPrototypeOf, global._inherits, global.newchainWeb3CoreMethod, global._regeneratorRuntime, global._asyncToGenerator, global._createClass, global._assertThisInitialized, global.isFunction, global.isObject, global.isBoolean, global.Hash, global.RLP, global.Bytes, global.account, global.newchainWeb3Core, global.scryptsy, global.isString, global.uuid));
}(this, function (exports, Utils, web3CoreHelpers, _classCallCheck, _possibleConstructorReturn, _getPrototypeOf, _inherits, newchainWeb3CoreMethod, _regeneratorRuntime, _asyncToGenerator, _createClass, _assertThisInitialized, isFunction, isObject, isBoolean, Hash, RLP, Bytes, account, newchainWeb3Core, scryptsy, isString, uuid) { 'use strict';
    ...
    function (_AbstractMethodFactor) {
      ...
      function MethodFactory(utils, formatters) {
        ...
        _this.methods = {
          getChainId: newchainWeb3CoreMethod.ChainIdMethod,
          getGasPrice: newchainWeb3CoreMethod.GasPriceMethod,
          getTransactionCount: newchainWeb3CoreMethod.GetTransactionCountMethod
        };
        return _this;
      }
      return MethodFactory;
    }(newchainWeb3CoreMethod.AbstractMethodFactory);
    ...
    function (_AbstractWeb3Module) {
            ...
            return _regeneratorRuntime.wrap(function _callee$(_context) {
              while (1) {
                switch (_context.prev = _context.next) {
                  ...
                  case 14:
                    _context.next = 16;
                    return this.transactionSigner.sign(tx, account.privateKey);
                  case 16:
      ...
      return Accounts;
    }(newchainWeb3Core.AbstractWeb3Module);
